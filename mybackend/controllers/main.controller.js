const StreamModel = require('../models/streamer.model'),
StreamController = () => {}

StreamController.SignUp = async (req,res,next) => {
    ...
    if(!userview){
        ...
        StreamModel.save(userToAdd, (error) =>{
            if(err){
...
StreamController.SignIn =  (req,res,next) =>{
  ...
  //  console.log(usertoFind)
    StreamModel.find(usertoFind,(err,rows)=> {
